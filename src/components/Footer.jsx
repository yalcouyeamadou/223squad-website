    ...
    return (
        <footer className="bg-stone-900 border-t border-amber-800/40 mt-auto">
            <div className="max-w-5xl mx-auto px-6 py-10 grid grid-cols-1 sm:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <div className="flex flex-col gap-2 text-sm">
                        <a href="tel:+22390003890" className="flex items-center gap-2 text-stone-300 hover:text-amber-400 transition-colors">
                            <Phone size={16} className="text-amber-500" />
                            (+223) 90 00 38 90
                        </a>
                        <a href="mailto:medpo9290@gmail.com" className="flex items-center gap-2 text-stone-300 hover:text-amber-400 transition-colors">
            ...
            <div className="border-t border-amber-800/20 py-4 text-center text-stone-500 text-xs">
                © {new Date().getFullYear()} 223SQUAD —  A~y :78 73 91 55 .Tous droits réservés · #223SQUAD
            </div>
        </footer>
    )
}
