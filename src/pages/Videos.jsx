  ...
  return (
    <div className="px-6 py-16 max-w-5xl mx-auto">
      ...
      {!loading && videos.length === 0 && (
        <p className="text-center text-stone-600 dark:text-stone-400">Aucune vidéo pour le moment.</p>
      )}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        {videos.map((url, i) => (
          <div
            key={i}
            className="rounded-xl overflow-hidden bg-stone-100 dark:bg-stone-900 border border-amber-800/30 dark:border-amber-800/40 hover:border-amber-500/60 transition-colors"
          >
