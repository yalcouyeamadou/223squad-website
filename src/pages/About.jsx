...
function About() {
    return (
        <div className="px-6 py-16 max-w-4xl mx-auto">
            ...
            <p className="text-stone-300 text-center max-w-2xl mx-auto mb-4">
                <span className="font-semibold text-amber-400">Un objectif. Une équipe. Une vision.</span>
            </p>
            <p className="text-stone-400 text-center max-w-2xl mx-auto mb-16 italic">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
                {values.map(({ icon: Icon, title, desc }) => (
                    <div key={title} className="flex flex-col items-center text-center">
                        <div className="w-14 h-14 flex items-center justify-center rounded-full bg-stone-900 border border-amber-800/40 mb-3">
